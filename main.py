⚡ѕιℓєиτ κιℓℓєя ϐογ⚡, [12/21/2021 6:53 PM]
import time
import json
import telebot
...
BOT_TOKEN = "5049040482:AAF5tLC9774dvQ-osfAfvfJOrEUahMhQnRs"
PAYMENT_CHANNEL = "@Payout_Galaxy" #add payment channel here including the '@' sign
OWNER_ID = 1194007250 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@omg_giveawayyy","@Online_Airdrops"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
